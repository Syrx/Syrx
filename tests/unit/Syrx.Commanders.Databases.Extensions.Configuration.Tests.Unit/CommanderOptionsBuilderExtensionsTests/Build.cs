using Z = Syrx.Commanders.Databases.Extensions.Configuration.Builders.CommanderOptionsBuilderExtensions;

namespace Syrx.Commanders.Databases.Extensions.Configuration.Tests.Unit.CommanderOptionsBuilderExtensionsTests
{
    public class Build
    {
