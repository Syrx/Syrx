using B = Syrx.Commanders.Databases.Extensions.Configuration.Builders.TypeSettingOptionsBuilderExtensions; 

namespace Syrx.Commanders.Databases.Extensions.Configuration.Tests.Unit.TypeSettingOptionsBuilderExtensionsTests
{
    public class Build
    {
