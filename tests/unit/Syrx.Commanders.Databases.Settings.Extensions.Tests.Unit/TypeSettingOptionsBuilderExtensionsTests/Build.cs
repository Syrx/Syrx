using B = Syrx.Commanders.Databases.Settings.Extensions.TypeSettingOptionsBuilderExtensions;

namespace Syrx.Commanders.Databases.Settings.Extensions.Tests.Unit.TypeSettingOptionsBuilderExtensionsTests
{
    public class Build
    {
