using B = Syrx.Commanders.Databases.Settings.Extensions.NamespaceSettingOptionsBuilderExtensions;

namespace Syrx.Commanders.Databases.Settings.Extensions.Tests.Unit.NamespaceSettingOptionsBuilderExtensionsTests
{
    public class Build
    {
