namespace Syrx.Commanders.Databases.Extensions.Configuration.Builders
{
    ...
    {
        private Dictionary<string, ConnectionStringSettingOptions> _connectionStrings;
        private Dictionary<string, NamespaceSettingOptions> _options;
...
New connection string: {options.ConnectionString}");
        ...
        public CommanderOptionsBuilder AddCommand(NamespaceSettingOptions options)
        {
        ...
        public void Evaluate(NamespaceSettingOptions option)
        {
        ...
        private IEnumerable<NamespaceSettingOptions> ValidateNamespaceCollections(IEnumerable<NamespaceSettingOptions> collection)
        {
        ...
        protected internal CommanderOptions Build()
        {
            ...
            return new CommanderOptions { Namespaces = namespaces.ToList(), Connections = connections };
        }
    }
