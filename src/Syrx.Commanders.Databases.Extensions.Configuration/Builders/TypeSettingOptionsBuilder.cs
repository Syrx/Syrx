namespace Syrx.Commanders.Databases.Extensions.Configuration.Builders
{
    public class TypeSettingOptionsBuilder<TType>
    {
        ...
        private Dictionary<string, CommandSettingOptions> _commands;
        ...
        protected internal TypeSettingOptions Build()
        {
            ...
            return new TypeSettingOptions { Commands = _commands, Name = _name };
        }
    }
}
