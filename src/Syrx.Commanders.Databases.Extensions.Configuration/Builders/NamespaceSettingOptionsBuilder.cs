namespace Syrx.Commanders.Databases.Extensions.Configuration.Builders
{
    public class NamespaceSettingOptionsBuilder
    {
        ...
        //private List<TypeSettingOptions> _types;
        private Dictionary<string, TypeSettingOptions> _types;
        ...
        public void Evaluate(TypeSettingOptions option)
        {
        ...
        protected internal NamespaceSettingOptions Build()
        {
            ...
            return new NamespaceSettingOptions
            {
